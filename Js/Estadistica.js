...
function estadisticas_por_mes() {
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:3000/estadisticas_por_mes'
    }).then(function (response) {
...
function estadisticas_planes() {
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:3000/estadisticas_De_Planes'//
    }).then(function (response) {
...
function pdf_estadisticas_Entrenador_y_sus_Usuarios() {
    ...
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:3000/estadisticas_Entrenador_y_sus_Usuarios',
        //
    }).then(function (response) {
        var body = [];
        //

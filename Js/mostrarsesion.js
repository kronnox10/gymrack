...
function MostrarRutinaCreada() {
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1:3000/MostrarNombreEntrenadorParaSesion',
        data: {
            id_usuario: ide
        ...
        axios({
            method: 'POST',
            url: 'http://127.0.0.1:3000/MostrarRutinaCreadaPorEntrenador',
            data: {
                id_usuario: ide
...
function MostrarSesionCreada() {
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1:3000/MostrarSesionCreadaPorUsuario',
        data: {
            id_usuario: ide
        },
    }).then(function (response) {
...
function video(tipo3, idnew) {
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1:3000/url_video',
        data: {
            tipo: tipo3,
            id_usuario: ide,
...
function mostrarDescripcion() {
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1:3000/MostrarDescripcionCreadaPorEntrenador',
        data: {
            tipo: vtipo,
            id_usuario: ide,
            name: vnombre,
